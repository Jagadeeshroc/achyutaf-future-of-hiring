...
const ExperienceItem = ({ experience, onRemove }) => {
  return (
    <motion.div
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-sm text-gray-500">
            {new Date(experience.from).toLocaleDateString()} - {experience.current ? 'Present' : new Date(experience.to).toLocaleDateString()}
          </p>
